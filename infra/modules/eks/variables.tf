...
variable "use_private_subnets" {
  description = "Deploy EKS cluster and nodes in private subnets (recommended)"
  type        = bool
  default     = true
}

variable "public_subnet_ids" {
  description = "List of public subnet IDs for EKS (only used if use_private_subnets = false)"
  type        = list(string)
  default     = []
}
